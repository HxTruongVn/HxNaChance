...
`save_layout`, `LAYOUT_PRESETS`). **UI:** `../ui/layout_tab_mixin.py`.
**Data:** `../config/presets/layout_presets.json` (14 công thức khổ
in).

## Đối tượng dùng

Cùng người dùng [Xưởng Xử lý ảnh](../photo_engine/README.md) — bước
